...
An online shopping website is running a Festive Sale. Customers who purchase products worth 
₹2,000 or more are eligible for a 20% discount.
...
Note: Use filter() to identify eligible products and map() to calculate the discounted prices. 
...
result = map(lambda x: x-(x*20/100), filter(lambda x: x>= 2000,prices))
print(list(result))