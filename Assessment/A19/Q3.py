...
Scenario:
You are developing a Smart Banking System for a bank to help customers perform basic banking 
operations such as deposit, withdrawal, balance checking, and interest calculation.

Sometimes, users may try to withdraw money or check balance before depositing any amount. 
        ...
        case 4:
            if deposit == None:
                ...
                if deposit > 50000:
                    ...
                    print("Updated Balance = ",deposit + interest)
                else:
                    interest = deposit * 3/100
                    print("Interest Added = ",interest)
                    print("Updated Balance = ",deposit + interest)
        case 5:
