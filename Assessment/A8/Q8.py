...
If wheat, high water supply; otherwise moderate supply. If temperature is less than 35, moderate supply.
 ...
 If rain expected, delay irrigation; otherwise light irrigation. 
...
type = int(input("Enter crop Type : "))
rain = input("Enter rain fall as yes or no : ")
...
if soil <= 30:
    if temp >= 35:
        if type == "wheat":
            ...
            print("Irrigation = Moderate Suplly")
    else:
